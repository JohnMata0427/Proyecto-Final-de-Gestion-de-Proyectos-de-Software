...
import '../../layouts/agendamiento/hora.dart';
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: TableCalendar(
                    ...
                    selectedDayPredicate: (day) {
                      return isSameDay(globals.selectedDay, day);
                    },
                ...
                if (isSelectDate) ...[
                  Text(
                      'Día seleccionado: ${globals.selectedDay!.toIso8601String().substring(0, 10)}',
                  ...
                  onPressed: () {
                    if (isSelectDate) {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const HoraCita()));
                    } else {
